...
<form name="form1"  class="form-horizontal" method="post" action="jspmlxbdcsjglxthsg2977WECE?ac=adminlogin&a=a">
    <div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login"
        ...
        <div class="layadmin-user-login-main" style="background: rgba(250,250,250,0.45);">
            ...
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                ...
                <div class="layui-form-item">
                    <div class="layui-row">
                        <div class="layui-col-xs7">
                            <%--@declare id="lay-user-login-vercode"--%><label class="layadmin-user-login-icon layui-icon layui-icon-vercode"
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="LAY-user-login-submit" id="loginBtn">登入
                    </button>
                </div>
            </div>
        </div>
